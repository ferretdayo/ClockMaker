...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <meta name="description" content="自分だけの時計を作ろう!数学系の方や情報系の方でそれぞれ個性的な時計を!" />
        <meta name="keywords" content="時計,時計作成,Twitter,Clock,ClockMaker" />
    ...
    <body>
        ...
        <ins class="adsbygoogle"
             style="display:inline-block;width:728px;height:90px;margin:10px auto;"
